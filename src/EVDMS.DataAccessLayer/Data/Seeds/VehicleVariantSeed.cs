            ...
            [
                ...
                new VehicleVariant
                {
                    ...
                    SpecsObject = new VehicleSpecs
                    {
                        ...
                        MotorType = new SpecDetail { Value = "Single PMSM" },
                        ...
                        BatteryChemistry = new SpecDetail { Value = "NCA" },
                        ...
                        ChargingPortTypes = new SpecDetail { Value = "CCS" },
                        ...
                        HeatPump = new SpecDetail { Value = "Optional" },
                ...
                new VehicleVariant
                {
                    ...
                    SpecsObject = new VehicleSpecs
                    {
                        ...
                        DriveType = new SpecDetail { Value = "AWD" },
                        MotorType = new SpecDetail { Value = "Induction Motor" },
                        ...
                        BatteryChemistry = new SpecDetail { Value = "NMC" },
                        ...
                        ChargingPortTypes = new SpecDetail { Value = "NACS" },
                        ...
                        V2lCapability = new SpecDetail { Value = 1.5, Unit = "kW" },
                    },
                    FeaturesObject = new VehicleFeatures
                    {
                        Safety =
                ...
                new VehicleVariant
                {
                    ...
                    SpecsObject = new VehicleSpecs
                    {
                        ...
                        DriveType = new SpecDetail { Value = "RWD" },
                        ...
                        BatteryChemistry = new SpecDetail { Value = "LFP" },
                        BatteryVoltageArchitecture = new SpecDetail { Value = 355, Unit = "V" },
                        RegenerativeBrakingCapacity = new SpecDetail
                        {
                            Value = "Standard (1‑pedal)",
