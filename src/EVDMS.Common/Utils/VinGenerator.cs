...
namespace EVDMS.Common.Utils
{
    public static class VinGenerator
    {
        ...
        // Deterministic6-char code from variant name
        public static string GetVariantCode(string variantName)
        {
            ...
            return sb.ToString()[..6]; // First6 hex chars
        }
    }
}
